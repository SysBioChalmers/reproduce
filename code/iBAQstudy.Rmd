...
sampleNames <- c('Abundance.iBAQ.R','Abundance.iBAQrescaled.R','Abundance.TPA.R','Abundance.TPAnorm.R')
...
ISnames <- c('Abundance.iBAQ.IS','Abundance.iBAQrescaled.IS','Abundance.TPA.IS','Abundance.TPAnorm.IS')
for(name in ISnames) {
...
par(mfcol = c(1,4), mar = c(1,2.5,2,1), cex = 1)
sampleNames <- c('Abundance.iBAQ.R..1_','Abundance.iBAQrescaled.R..1_','Abundance.TPA.R..1_','Abundance.TPAnorm.R..1_')
