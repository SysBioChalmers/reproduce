...
<br>
<center>**Figure 6: ES curves (abundance Vs iBAQ peaks of UPS2), original (red) Vs rescaled (green)**</center>
<br>
...
In conclusion, by assuming that the iBAQ data should always adds up to a given protein amount, we can reproduce almost exactly the ES curves, and achieve more consistent results accross samples. The ES curve achieved with UPS2 therefore is only useful to get an estimate of the detected total protein amount of the IS by the iBAQ peaks.
<br>
...
The fits are actually better than in figure 3, suggesting that, at least for this dataset, protein abundance correlates better to raw MS peaks than iBAQ peaks. We will then proceed with only raw MS peaks in the analysis.
<br>
...
<br>
<center>**Figure 13: ES curves (abundance Vs raw H peaks of UPS2), original (red) Vs rescaled (green)**</center>
<br>

Again, comparing these fits to figure 6, we see how the variability for a single protein measurement is higher in iBAQ peaks than in simple raw MS peaks.
<br>
...
<center>**Figure 15: Comparison of data variability without rescaling (top row), rescaling to iBAQ (middle row) and rescaling to SILAC (bottom row). In the variability plots (left and middle) green is a FC < 2, yellow between 2 and 10, and red > 10. In the PCA plots (right), colors refer to technical replicates and shapes to biological replicates.**</center>
<br>
...
5. How relevant are these findings? Old news or actually something interesting? Most times I've only seen a single ES curve and no technical replicates...
