...
```{r general-length, fig.height = 7, fig.width = 7, fig.align="center", fig.cap = "\\label{fig:general-length}Predicted abundances [fmol/sample] Vs protein length for all methods."}
...
plotAbundancesVsLength(SILACdata,sampleNames,titleNames)
```
