...
```{r precision-violin, fig.height = 2.5, fig.width = 5,  fig.align = "center", fig.cap = "\\label{fig:precision-violin}Violin plots of CVs between batches. Colors represent the methods: 1) iBAQ (blue), 2) iBAQ rescaled (gray), 3) TPA (brown) and 4) TPA normalized (yellow)."}
par(mfrow = c(1,1), mar = c(2,4,0.5,0.5), cex = 0.8)
