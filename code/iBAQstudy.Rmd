...
par(mfcol = c(1,4), mar = c(0.5,2.5,1.5,1), cex = 0.5)
...
par(mfrow = c(2,2), mar = c(3.5,4,2,2), cex = 0.7)
...
par(mfrow = c(4,1), mar = c(4,4,2,1), cex = 0.8)
...
par(mfrow = c(1,2), mar = c(3.5,4,2,1), cex = 0.7)
...
We can also look at technical variability by plotting each FC to the corresponding abundance, together with a "UPS2 window" that shows the abundance levels that are detected by the UPS2:
