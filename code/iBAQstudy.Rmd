...
We can see this again for the 18 sample intensities inferred from the L/H ratios:
...
Let's look further into the reduction of batch variability, by looking at the cumulative distribution of batch variability between IS measurements for each method:
...
This can be confirmed when looking at the sample data by using the L/H ratios:
