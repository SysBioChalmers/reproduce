...
We see that in fact sequence length works as a good proxy for the number of theoretical peptides. Let's now see the predicted abundances of all samples compared to the sequence length:
