...
<center>**Figure 4: ES curves (log10(abundance [pg/sample]) in y-axis Vs log10(MS intensity) in x-axis), with (green) and without (red) rescaling.**</center>
<br>
...
<br>
<center>**Figure 5: ES curves (abundance Vs MS intensities of UPS2), with (green) and without (red) rescaling. Average coefficient of variation (CVm) within each protein is shown in the upper left corner.**</center>
<br>
