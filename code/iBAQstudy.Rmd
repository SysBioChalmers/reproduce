...
We now plot the comparison for all methods:
...
<center>**Figure 1: Comparison of predicted Vs real abundance values [fmol/sample] from UPS2, according to all methods. Green is a FC < 2, yellow between 2 and 10, and red > 10.**</center>
<br>
...
MSRvsIBAQ <- cbind(abundanceIBAQ[,-1],abundanceTPAN[,-1])
...
plotVariability(MSRvsIBAQ, c('iBAQ.R','TPAnorm.R'), '', 'iBAQ [fmol/sample]', 'MS rescaled [fmol/sample]', FALSE)
```

<center>**Figure 2: Comparison of predictions [fmol/sample] between all methods. Green is a FC < 2, yellow between 2 and 10, and red > 10.**</center>
<br>
