...
We will also try out to first normalize all MS intensitiy values by the corresponding number of theoretical peptides [@Wisniewski2012]:
...
Let's look further into the reduction of batch variability, by looking at the cumulative distribution of each method:
...
plotCumulativeDistrib(techFC,'Batch variability')
```
